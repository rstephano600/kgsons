...
@section('content')
<div class="container">
    <h2 class="mb-4">Drinks Sales Dashboard</h2>
...
<div class="card shadow-sm mb-4">
    ...
    <div class="card-body">
        <form method="GET" action="{{ route('reports.drink_sales') }}">
            <div class="row g-3">
                <!-- Start Date -->
                <div class="col-md-4">
                ...
                <div class="col-md-4 d-flex align-items-end">
                    <div class="btn-group w-100">
                        ...
                        <button type="submit" formaction="{{ route('reports.drink_sales.export') }}" name="format" value="xlsx" class="btn btn-success">
                            <i class="bi bi-file-earmark-excel-fill me-1"></i> Excel
                        </button>
                        <button type="submit" formaction="{{ route('reports.drink_sales.export') }}" name="format" value="csv" class="btn btn-info">
                            <i class="bi bi-filetype-csv me-1"></i> CSV
                        </button>
                        <button type="submit" formaction="{{ route('reports.drink_sales.export') }}" name="format" value="pdf" class="btn btn-danger">
    ...
    <table class="table table-bordered table-striped">
        <thead>
            <tr>
                <th>#</th><th>Drink</th><th>Qty</th><th>Price</th><th>Total</th><th>Payment</th><th>Paid At</th>
            </tr>
        </thead>
        <tbody>
